...
public partial class MainView: Fuse.App
{
    ...
    public partial class Template2: Uno.UX.Template
    {
        [Uno.WeakReference] internal readonly MainView __parent;
        [Uno.WeakReference] internal readonly MainView __parentInstance;
        public Template2(MainView parent, MainView parentInstance): base("Profile", false)
        {
            __parent = parent;
            __parentInstance = parentInstance;
        }
    ...
    public partial class Template3: Uno.UX.Template
    {
        [Uno.WeakReference] internal readonly MainView __parent;
        [Uno.WeakReference] internal readonly MainView __parentInstance;
        public Template3(MainView parent, MainView parentInstance): base("Messages", false)
        {
            __parent = parent;
            __parentInstance = parentInstance;
        }
        ...
        public override object New()
        {
            var __self = new global::MessagesPage(__parent.router);
            __self.Name = __selector0;
            return __self;
        }
    ...
    void InitializeUX()
    {
        ...
        var Profile = new Template2(this, this);
        var Messages = new Template3(this, this);
        this.Background = float4(0.06666667f, 0.1019608f, 0.1921569f, 1f);
        ...
        temp18.Color = float4(0.06666667f, 0.1019608f, 0.1921569f, 1f);
        router.Name = __selector0;
        temp19.DefaultPath = "login";
        temp19.Templates.Add(login);
        temp19.Templates.Add(Home);
        temp19.Templates.Add(Profile);
        temp19.Templates.Add(Messages);
