...
public partial class MessagesPage: Fuse.Controls.Panel
{
    readonly Fuse.Navigation.Router router;
    [Uno.Compiler.UxGenerated]
    public partial class Template: Uno.UX.Template
    {
        [Uno.WeakReference] internal readonly MessagesPage __parent;
        [Uno.WeakReference] internal readonly MessagesPage __parentInstance;
        public Template(MessagesPage parent, MessagesPage parentInstance): base(null, false)
        {
            __parent = parent;
    ...
    void InitializeUX()
    {
        ...
        mainAppTranslation_X_inst = new Selfie_FuseTranslation_X_Property(mainAppTranslation, __selector0);
        topMenuTranslation = new global::Fuse.Translation();
        topMenuTranslation_Y_inst = new Selfie_FuseTranslation_Y_Property(topMenuTranslation, __selector1);
        bottomMenuTranslation = new global::Fuse.Translation();
        bottomMenuTranslation_Y_inst = new Selfie_FuseTranslation_Y_Property(bottomMenuTranslation, __selector1);
        middleRectangle = new global::Fuse.Controls.Rectangle();
        middleRectangle_Opacity_inst = new Selfie_FuseElementsElement_Opacity_Property(middleRectangle, __selector2);
        topMenuRotation = new global::Fuse.Rotation();
        topMenuRotation_Degrees_inst = new Selfie_FuseRotation_Degrees_Property(topMenuRotation, __selector3);
        bottomMenuRotation = new global::Fuse.Rotation();
        bottomMenuRotation_Degrees_inst = new Selfie_FuseRotation_Degrees_Property(bottomMenuRotation, __selector3);
        topRectangle = new global::Fuse.Controls.Rectangle();
        topRectangle_Width_inst = new Selfie_FuseElementsElement_Width_Property(topRectangle, __selector4);
        bottomRectangle = new global::Fuse.Controls.Rectangle();
        bottomRectangle_Width_inst = new Selfie_FuseElementsElement_Width_Property(bottomRectangle, __selector4);
        ...
        temp_Value_inst = new Selfie_FuseTriggersWhileBool_Value_Property(temp, __selector5);
        var temp5 = new global::Fuse.Reactive.Data("sidebarOpen");
        var temp1 = new global::Fuse.Triggers.WhileFalse();
        temp1_Value_inst = new Selfie_FuseTriggersWhileBool_Value_Property(temp1, __selector5);
        ...
        temp2_Items_inst = new Selfie_FuseReactiveEach_Items_Property(temp2, __selector6);
        ...
        temp_eb5 = new global::Fuse.Reactive.EventBinding(temp3, __g_nametable);
        var temp22 = new global::Fuse.Navigation.WhileInactive();
        var temp23 = new global::Fuse.Triggers.Actions.Callback();
        temp_eb6 = new global::Fuse.Reactive.EventBinding(temp4, __g_nametable);
        ...
        temp9.LineNumber = 3;
        temp9.FileName = "Pages/Messages/MessagesPage.ux";
        temp9.File = new global::Uno.UX.BundleFileSource(import global::Uno.IO.BundleFile("../../../Pages/Messages/MessagesPage.js"));
        ...
        temp10.LineNumber = 5;
        temp10.FileName = "Pages/Messages/MessagesPage.ux";
